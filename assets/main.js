    ...
    if (data.results && data.results.length > 0) {
        ...
        data.results.forEach(result => {
            ...
            itemDiv.innerHTML = `
                ...
                ${currentTrainNo ? `<p><strong>本务车次:</strong> <span class="current-train-no"><a href="https://rail.re/#${trainModel}${trainNumber}" style="color: #ADD8E6; text-decoration: none; font-weight: bold;">${currentTrainNo}</a></span></p>` : ''}
            `;
