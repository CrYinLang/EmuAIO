...
class _GalleryPageState extends State<GalleryPage> {
  ...
  void initState() {
    ...
    webController = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://china-emu.cn/Trains/ALL/'));
  }
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () => setState(() => showFullGallery = !showFullGallery),
  ...
  Widget _buildResultItem(TrainInfo train) {
    ...
    // 使用 Provider.of 获取设置，替代 Consumer
